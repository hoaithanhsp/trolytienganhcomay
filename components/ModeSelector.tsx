...
const ModeSelector: React.FC<ModeSelectorProps> = ({ currentMode, onSelectMode, disabled }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-2 mb-4 p-3 bg-white/60 backdrop-blur-sm rounded-xl border border-teal-100">
          ...
          return (
            <button
              ...
              className={`
                ...
                border
                ${isSelected 
                  ? `${info.color} ring-1 ring-offset-1 ring-offset-white ring-slate-300 shadow-sm` 
                  : 'bg-white text-slate-600 border-slate-200 hover:bg-teal-50 hover:border-teal-200'
                }
